...
**[SAGPT-CENEIN](https://github.com/martiponce/SAGPT_CENEIN)** — Sistema Administrativo de Gestión de Pacientes y Turnos

Aplicación de escritorio desarrollada en C# (.NET Framework 4.8) con arquitectura en 3 capas (Presentación, Servicios, DAL) sobre SQL Server, para la gestión integral de un centro de salud: pacientes, turnos, control de asistencia, auditoría y dashboard gerencial con KPIs. Proyecto final de la carrera de Analista de Sistemas.

`C#` `.NET Framework` `SQL Server` `ADO.NET` `Windows Forms` `LINQ`
